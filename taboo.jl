...
all = get_data(FILES)
dist_matr = all[4][2:end,2:end] # 2 -> 48 ; 3 -> 76 ; 4 -> 127
#startingcity = [i for i in 1:127]

startingcity = [120, 114, 106, 15, 6, 108, 41, 39, 26, 81, 63, 119, 88, 86, 85, 102, 101, 98, 83, 82, 126, 79, 20, 4, 74, 75, 69, 96, 109, 87, 70, 68, 73, 72, 21, 17, 12, 14, 30, 97, 123, 95, 43, 34, 38, 32, 29, 25, 27, 31, 80, 117, 84, 78, 76, 77, 18, 22, 105, 7, 1, 16, 13, 35, 40, 42, 28, 122, 33, 9, 60, 61, 91, 100, 64, 58, 62, 59, 71, 110, 104, 92, 99, 89, 125, 11, 24, 23, 19, 8, 67, 116, 90, 3, 10, 52, 124, 112, 111, 107, 127, 93, 103, 44, 45, 94, 46, 118, 48, 49, 53, 47, 66, 113, 65, 55, 54, 57, 36, 37, 2, 51, 121, 56, 5, 50, 115]

#startingcity = sample(1:127, 127, replace = false)
#println("\n Nowe miasto",startingcity)


println(Taboo_Search(dist_matr,startingcity,500,20),"\n\n\n")

println(Taboo_Search(dist_matr,startingcity,500,30),"\n\n\n")

println(Taboo_Search(dist_matr,startingcity,500,40),"\n\n\n")
