...
all = get_data(FILES)
n_cities = length(all[2][:,1])
distance_matrix = copy(all[2])

print(n_cities)
#all[4] = copy(diagonal_to_zero(all[4]))

#result1 = GA(100,all[2],30,20,0.3,true,true)
#result2 = GA(100,all[2],30,20,0.3,false,true)
#result3 = GA(100,all[2],30,20,0.3,true,false)
#result4 = GA(100,all[2],30,20,0.3,false,false)

function get_results(bool1,bool2,configuration)
    liczbapokolen = [200,300,400,500] #300,400,500
    liczbapotomkow = [20,30,40,50]  #30,40,50
    prawdmutacji = [0.1,0.2,0.3,0.4] #,0.2,0.3,0.4
